...
var apiVersionCve = "CVE-2021-45046"
...
var KnownVulnerableClassFileHashes = types.VulnerableHashLookup{
	...
	"03c77cca9aeff412f46eaf1c7425669e37008536dd52f1d6f088e80199e4aae7": { Name:"log4j 2.4-2.11.2", CVE: log4shellCve },    // JndiManager$1.class
	...
	"547883afa0aa245321e6b1aaced24bc10d73d5af4974d951e2bd53b017e2d4ab": { Name:"log4j 2.14.0-2.14.1", CVE: log4shellCve }, // JndiManager$JndiManagerFactory.class
	"620a713d908ece7fb09b7d34c2b0461e1c366704da89ea20eb78b73116c77f23": { Name:"log4j 2.1-2.3", CVE: log4shellCve },       // JndiManager$1.class
	"632a69aef3bc5012f61093c3d9b92d6170fdc795711e9fed7f5388c36e3de03d": { Name:"log4j 2.8.2", CVE: log4shellCve },         // JndiManager$JndiManagerFactory.class
	"635ccd3aaa429f3fea31d84569a892b96a02c024c050460d360cc869bcf45840": { Name:"log4j 2.9.1-2.10.0", CVE: log4shellCve },  // JndiManager$JndiManagerFactory.class
	...
	"8abaebc4d09926cd12b5269c781b64a7f5a57793c54dc1225976f02ba58343bf": { Name:"log4j 2.13.0-2.13.3", CVE: log4shellCve }, // JndiManager$JndiManagerFactory.class
	"91e58af100aface711700562b5002c5d397fb35d2a95d5704db41461ac1ad8fd": { Name:"log4j 2.1-2.3", CVE: log4shellCve },       // JndiManager$JndiManagerFactory.class
	"ae950f9435c0ef3373d4030e7eff175ee11044e584b7f205b7a9804bbe795f9c": { Name:"log4j 2.1-2.3", CVE: log4shellCve },       // JndiManager.class
	"aec7ea2daee4d6468db2df25597594957a06b945bcb778bbcd5acc46f17de665": { Name:"log4j 2.4-2.6.2", CVE: log4shellCve },     // JndiManager$JndiManagerFactory.class
	"b8af4230b9fb6c79c5bf2e66a5de834bc0ebec4c462d6797258f5d87e356d64b": { Name:"log4j 2.7-2.8.1", CVE: log4shellCve },     // JndiManager$JndiManagerFactory.class
	...
	"e4906e06c4e7688b468524990d9bb6460d6ef31fe938e01561f3f93ab5ca25a6": { Name:"log4j 2.8.2-2.12.0", CVE: log4shellCve },  // JndiManager$1.class
	"fe15a68ef8a75a3f9d3f5843f4b4a6db62d1145ef72937ed7d6d1bbcf8ec218f": { Name:"log4j 2.12.0-2.12.1", CVE: log4shellCve }, // JndiManager$JndiManagerFactory.class
	"0ebc263ba66a7452d3dfc15760c560f930d835164914a1340d741838e3165dbb": { Name:"log4j 2.4-2.5", CVE: log4shellCve },       // MessagePatternConverter.class
	"52b5574bad677030c56c1a386362840064d347523e61e59ca1c55faf7e998986": { Name:"log4j 2.12", CVE: log4shellCve },          // MessagePatternConverter.class
	"5c328eedefcb28512ff5d9a7556741dd159f0b13e1c0c52edc958d9821b8d2c5": { Name:"log4j 2.6", CVE: log4shellCve },           // MessagePatternConverter.class
	"791a12347e62d9884c4d6f8e285098fedaf3bcdf591af3e4449923191588d43c": { Name:"log4j 2.8-2.9", CVE: log4shellCve },       // MessagePatternConverter.class
	"8d5e886175b66ec2de5b61113fdaf06c50e1070cad1fb9150258e01d84d13c4b": { Name:"log4j 2.13", CVE: log4shellCve },          // MessagePatternConverter.class
	"95b385ebc65843315aeae33551e7bbdad886e9e9465ea8d3179cd74344b37984": { Name:"log4j 2.10-2.11", CVE: log4shellCve },     // MessagePatternConverter.class
	"a36c2e78cef7c2ddcc4ebbb11c085e85989eb93f9d19bd6254913b13dfe7c58e": { Name:"log4j 2.0-2.3", CVE: log4shellCve },       // MessagePatternConverter.class
	"a3a65f2c5bc0dd62df115a0d9ac7140793c61b65bbbac313a526a3b50724a8c7": { Name:"log4j 2.8.2", CVE: log4shellCve },         // MessagePatternConverter.class
	"ee41ae7ae80f5c533548a89c6d6e112df609c838b901daea99ac88ccda2a5da1": { Name:"log4j 2.7", CVE: log4shellCve },           // MessagePatternConverter.class
	"f0a869f7da9b17d0a23d0cb0e13c65afa5e42e9567b47603a8fc0debc7ef193c": { Name:"log4j 2.14", CVE: log4shellCve },          // MessagePatternConverter.class
	"f8baca973f1874b76cfaed0f4c17048b1ac0dee364abfdfeeec62de3427def50": { Name:"log4j 2.0-rc1", CVE: log4shellCve },       // MessagePatternConverter.class

	"ce69c1ea49c60f3be90cb9c86d7220af86e5d2fbc08fd7232da7278926e4f881": { Name:"log4j 2.0-alpha1/alpha2/beta1", CVE: log4shellCve }, // MessagePatternConverter.class
	"963ee03ebe020703fea27f657496d35edeac264beebeb14bfcd9d3350343c0bf": { Name:"log4j 2.0-beta2/beta3", CVE: log4shellCve },         // MessagePatternConverter.class
	"be8f32ed92f161df72248dcbaaf761c812ddbb59434abfd5c87482e9e0bd983c": { Name:"log4j 2.0-beta4", CVE: log4shellCve },               // MessagePatternConverter.class
	"9a54a585ed491573e80e0b32e964e5eb4d6c4068d2abffff628e3c69ef9102cf": { Name:"log4j 2.0-beta5", CVE: log4shellCve },               // MessagePatternConverter.class
	"357120b06f61475033d152505c3d43a57c9a9bdc05b835d0939f1662b48fc6c3": { Name:"log4j 2.0-beta6/beta7/beta8", CVE: log4shellCve },   // MessagePatternConverter.class
	...
	"84057480ba7da6fb6d9ea50c53a00848315833c1f34bf8f4a47f11a14499ae3f" :{ Name:"log4j 2.15.0", CVE: apiVersionCve }, // JNDILookup.class
	"db07ef1ea174e000b379732681bd835cfede648a7971bf4e9a0d31981582d69e" :{ Name:"log4j 2.15.0", CVE: apiVersionCve }, // JNDIManager.class
	"5bfbecc21f5de442035c0361c994c379a4f6b5adb280c66e43256c6f09346bd1" :{ Name:"log4j 2.15.0", CVE: apiVersionCve }, // MessagePatternConverter.class
...
var KnownVulnerableArchiveFileHashes = types.VulnerableHashLookup{
	...
	// The following shas for version 2.15 detect a valid but lower level of severity vulnerability, CVE  CVE-2021-45046
	"e7048ad52e3b6f1267b7ceb2c07200a5ce61271bcf59f98fd238bf60e4137932": { Name:"apache-log4j-2.15.0-bin/log4j-core.2.15.0.jar", CVE: apiVersionCve},
	}
