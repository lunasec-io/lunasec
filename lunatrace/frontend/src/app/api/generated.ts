...
export type GetVulnerabilitiesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetVulnerabilitiesQuery = { __typename?: 'query_root', vulnerabilities: Array<{ __typename?: 'vulnerabilities', id: any, name: string }> };


export const GetVulnerabilitiesDocument = `
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    GetVulnerabilities: build.query<GetVulnerabilitiesQuery, GetVulnerabilitiesQueryVariables | void>({
      query: (variables) => ({ document: GetVulnerabilitiesDocument, variables })
    }),
  }),
});

export { injectedRtkApi as api };
export const { useGetVulnerabilitiesQuery, useLazyGetVulnerabilitiesQuery } = injectedRtkApi;
