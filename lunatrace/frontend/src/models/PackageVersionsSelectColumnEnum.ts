...
export enum PackageVersionsSelectColumn {
  cpes="cpes",
fix_state="fix_state",
...
/**
* PackageVersionsSelectColumn
 *
 * select columns of table "package_versions"
*/
export const PackageVersionsSelectColumnEnumType = types.enumeration("PackageVersionsSelectColumn", [
        "cpes", // column name
