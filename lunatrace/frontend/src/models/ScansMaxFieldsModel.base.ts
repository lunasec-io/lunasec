...
/**
 * ScansMaxFieldsBase
 * auto generated base class for the model ScansMaxFieldsModel.
 *
 * aggregate max on columns
 */
export const ScansMaxFieldsModelBase = ModelBase
  .named('ScansMaxFields')
  .props({
    __typename: types.optional(types.literal("scans_max_fields"), "scans_max_fields"),
...
export class ScansMaxFieldsModelSelector extends QueryBuilder {
...
export function selectFromScansMaxFields() {
  return new ScansMaxFieldsModelSelector()
}

export const scansMaxFieldsModelPrimitives = selectFromScansMaxFields().created_at.db_date.distro_name.distro_version.grype_version.project_id.sbom_id.source_type.target
