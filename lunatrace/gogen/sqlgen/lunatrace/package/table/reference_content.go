...
var ReferenceContent = newReferenceContentTable("package", "reference_content", "")
...
func newReferenceContentTableImpl(schemaName, tableName, alias string) referenceContentTable {
	var (
		...
		allColumns                = postgres.ColumnList{IDColumn, PackageIDColumn, URLColumn, ContentColumn, NormalizedContentColumn, ContentTypeColumn, LastSuccessfulFetchColumn}
		mutableColumns            = postgres.ColumnList{PackageIDColumn, URLColumn, ContentColumn, NormalizedContentColumn, ContentTypeColumn, LastSuccessfulFetchColumn}
	)
