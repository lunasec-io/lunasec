...
ALTER TABLE vulnerability.range ADD CONSTRAINT range_uniq UNIQUE (affected_id, introduced, fixed);
...
ALTER TABLE vulnerability.vulnerability ADD COLUMN reviewed_by_source boolean NULL;
