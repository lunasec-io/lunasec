...
ALTER TABLE public.projects ADD COLUMN settings_id uuid REFERENCES public.settings;

ALTER TABLE public.organizations DROP COLUMN settings_id;
ALTER TABLE public.organizations ADD COLUMN settings_id uuid REFERENCES public.settings;
