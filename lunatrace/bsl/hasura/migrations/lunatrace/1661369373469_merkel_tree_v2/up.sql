...
ALTER TABLE manifest_dependency
    ADD FOREIGN KEY (manifest_dependency_node_id) REFERENCES manifest_dependency_node (id);

ALTER TABLE manifest_dependency_node
    ADD FOREIGN KEY (release_id) REFERENCES package.release (id);

ALTER TABLE manifest_dependency_edge
    ADD FOREIGN KEY (parent_id) REFERENCES manifest_dependency_node (id);

ALTER TABLE manifest_dependency_edge
    ADD FOREIGN KEY (child_id) REFERENCES manifest_dependency_node (id);
