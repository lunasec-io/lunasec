ALTER TABLE "public"."organizations" DROP COLUMN "installation_id";
ALTER TABLE "public"."organizations" DROP COLUMN "github_id";

ALTER TABLE "public"."projects" DROP CONSTRAINT "projects_name_organization_id_key";
