...
alter table "analysis"."manifest_dependency_edge_result" add constraint "manifest_dependency_edge_result_manifest_dependency_edge_id_vul" unique ("vulnerability_id", "manifest_dependency_edge_id", "finding_source", "finding_source_version");
