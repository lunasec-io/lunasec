...
class ReadAdvisory(BaseTool):
	...
	description = """Used to read a specific advisory from the list of advisories in the VulnInfo response. 
				  Takes a two element javascript style array as input, where the first element is the UUID advisory ID and the second element is a command
				  of what to look for in the advisory. Ex: ["6e100df0-e4f0-4306-8c45-da8b851f7776", "tell me what java versions are vulnerable"]
				  """
	...
	def _run(self, input: str) -> str:
		...
		content = summarize(contents[0]["parsed_content"], query)
		return content
