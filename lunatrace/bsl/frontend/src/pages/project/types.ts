...
import { GetBuildLogsQuery, GetProjectInstancesQuery, GetProjectQuery } from '../../api/generated';
...
export type InstanceInfo = GetProjectInstancesQuery['instances'][number];
