    ...
    <>
      ...
      <Row>
        {data.analysis_manifest_dependency_edge_result.map((r) => {
          ...
          const analysisCmd = `mkdir -p /tmp/lunasec-package-test && cd /tmp/lunasec-package-test && echo '{ "name": "package-test", "dependencies": {"${parentPackage}": "${parentPackageVersion}"} }' > package.json && npm i && analysiscli code-calls-dependency --dependency ${childPackage} .`;
