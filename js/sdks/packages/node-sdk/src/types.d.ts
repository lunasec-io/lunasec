 ...
 */
export declare enum SecureResolverAction {
    build = "build",
...
export declare type ValidStages = 'dev' | 'prod';
export declare type ValidSecureResolverApiRequestTypes = keyof typeof SecureResolverAction | keyof SecureResolverActionResponseMessageMap | keyof SecureResolverActionMessageMap;
...
export declare type SecureResolverActionLookup = {
...
export declare type SecureResolverResponseLookup = {
