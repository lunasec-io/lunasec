...
Copying and communicating all the information and events to make the various elements look and behave like native elements was a
serious undertaking. The end result is something that looks and behaves just like a native element, even working well with popular
