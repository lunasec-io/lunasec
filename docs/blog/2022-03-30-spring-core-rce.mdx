...
Without being run on a Tomcat server, the above logging properties will not exist. Without TomCat another, as of yet unknown method of exploitation would be needed.
