...
![Spring4Shell Logo](https://www.lunasec.io/docs/img/spring4shell-logo.png "yoyoyyoyoy")
...
Without being run on a Tomcat server, the above logging properties will not exist and another, as of yet unknown method of exploitation would be needed.
