...
If you're using Spring Core, thre are currently two remediations for patching this attack. There is no official patch
available (as of 3-31-2022 @ 6:30am UTC). 

There is an [unofficial patch](https://github.com/blindpirate/spring-rce-2022-03-hotfix) which uses bytecode manipulation to patch the affected application.

Alternatively, according to the [Praetorian post](https://www.praetorian.com/blog/spring-core-jdk9-rce/) confirming the presence of an
