...
Mitigating a vulnerability in a single dependency used in one project is often difficult.
...
single dependency, either. Mitigating Log4Shell isn't just a matter of updating _your_ code, but it also requires
