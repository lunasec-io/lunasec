...
CRA will do something similar but I stopped holding my breath a while ago, so let's install Craco.
...
have this called `ControlledCSS` or `DynamicCSS` or something similar.  Naming, after all, is most of programming. If I can't find something, I won't know to use it.
