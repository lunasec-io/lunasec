...
## Misguided Log4Shell Advice Online
...
## Determine Whether You are Impacted by Log4Shell
...
[are kept up to date](https://github.com/lunasec-io/lunasec/blob/master/tools/log4shell/log4j-library-hashes.json) with all
...
Almost all versions of `log4j` v2 are affected.
...
## Protect Yourself From Future 0-days
